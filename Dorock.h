...
public:
    ...
    void drawDorock(glm::mat4 modelMtx, glm::mat4 viewMtx, glm::mat4 projMtx) const;
...
private:
    ...
    /// \param viewMtx camera view matrix to apply
    /// \param projMtx camera projection matrix to apply
    void drawBase(glm::mat4 modelMtx, glm::mat4 viewMtx, glm::mat4 projMtx ) const;

    /// \param modelMtx existing model matrix to apply
    /// \param viewMtx camera view matrix to apply
    /// \param projMtx camera projection matrix to apply
    void drawFace(glm::mat4 modelMtx, glm::mat4 viewMtx, glm::mat4 projMtx ) const;
